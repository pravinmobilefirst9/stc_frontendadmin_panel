...
import { headerData3 } from "../data/header";
              ...
              {currentItems.length > 0 ? (
                currentItems.map((data, idx) => (
                  <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td className="px-6 py-4">{data?.transcationStatus}</td>
                  </tr>
                ))
              ) : (
                <>
...
function ApproveTable({ itemsPerPage, requestData, setState, state, balance }) {
